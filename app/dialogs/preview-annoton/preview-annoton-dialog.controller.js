...
export default class PreviewAnnotonDialogController {
...
PreviewAnnotonDialogController.$inject = ['saeConstants', '$scope', '$rootScope', '$mdDialog', 'dialogService', 'graph', 'lookup', 'formGrid', 'data'];